...
setwd(dir = "~/PD/Data/OoL/43_Draft_5/_fig2/_coacervates")
```
...
ggsave(fig2b, file="./fig2b.png",width = 7, height = 7, device = "png")
```
...
ggsave(fig2c, file="./fig2c.png",width = 7, height = 7, device = "png")
```